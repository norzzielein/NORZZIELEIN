<div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
    <!-- First Trailer -->
    <img src="IMPORT FILES/GitHubProfileTrailer.png" alt="GitHub Profile Trailer" style="width: 20%; max-width: 284px; height: 32px;" />
    <!-- Icons Container -->
    <div style="display: flex; justify-content: space-between; flex-grow: 1;">
        <!-- E-MAIL -->
        <a href="mailto:norieneil_acosta@outlook.com" title="E-MAIL: norieneil_acosta@outlook.com"> <img src="IMPORT FILES/EmailIcon.png" alt="Email Address" style="width: 20%; max-width: 32px; height: 32px;"></a>
        <!-- PHONE -->
        <a href="tel:09673381501" title="PHONE: 09673381501"> <img src="IMPORT FILES/TelephoneIcon.png" alt="Contact Number" style="width: 20%; max-width: 32px; height: 32px;"></a>
        <!-- LINKEDIN -->
        <a href="https://www.linkedin.com/in/norzzielein" title="LINKEDIN: https://www.linkedin.com/in/norzzielein"> <img src="IMPORT FILES/LinkedInIcon.png" alt="LinkedIn Account" style="width: 20%; max-width: 32px; height: 32px;"></a>
        <!-- GITHUB -->
        <a href="https://github.com/norzzielein" title="GITHUB: https://github.com/norzzielein"> <img src="IMPORT FILES/GitHubIcon.png" alt="GitHub Account" style="width: 20%; max-width: 32px; height: 32px;"></a>
        <!-- FACEBOOK -->
        <a href="https://www.facebook.com/norzzielein" title="FACEBOOK: https://www.facebook.com/norzzielein"> <img src="IMPORT FILES/FacebookIcon.png" alt="Facebook Account" style="width: 20%; max-width: 32px; height: 32px;"></a>
        <!-- INSTAGRAM -->
        <a href="https://www.instagram.com/norzzielein" title="INSTAGRAM: https://www.instagram.com/norzzielein"> <img src="IMPORT FILES/InstagramIcon.png" alt="Instagram Account" style="width: 20%; max-width: 32px; height: 32px;"></a>
        <!-- TWITTER -->
        <a href="https://twitter.com/norzzielein" title="TWITTER: https://twitter.com/norzzielein"> <img src="IMPORT FILES/TwitterIcon.png" alt="Twitter Account" style="width: 20%; max-width: 32px; height: 32px;"></a>
    </div>
    <!-- Second Trailer -->
    <img src="IMPORT FILES/GitHubProfileTrailer.png" alt="GitHub Profile Trailer" style="width: 20%; max-width: 284px; height: 32px;" />
</div>
...
<div style = "display: flex; flex-direction: column; align-items: center;">
    ...
    <div align = "center" style = "width: 100%;">
        ...
        <!-- GITHUB -->
        <a href = "https://github.com/norzzielein" title = "GITHUB: https://github.com/norzzielein"> <img src = "IMPORT FILES/GitHubIcon.png" alt = "GitHub Account" style = "width: 32px; height: 32px"></a>
        <!-- FACEBOOK -->
        <a href = "https://www.facebook.com/norzzielein" title = "FACEBOOK: https://www.facebook.com/norzzielein"> <img src = "IMPORT FILES/FacebookIcon.png" alt = "Facebook Account" style = "width: 32px; height: 32px"></a>
        <!-- INSTAGRAM -->
        <a href = "https://www.instagram.com/norzzielein" title = "INSTAGRAM: https://www.instagram.com/norzzielein"> <img src = "IMPORT FILES/InstagramIcon.png" alt = "Instagram Account" style = "width: 32px; height: 32px"></a>
        <!-- TWITTER -->
