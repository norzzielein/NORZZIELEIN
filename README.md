...
- #### HONOR GRADUATE ELIGIBILITY <br> Presidential Decree No. 907 (Honor Graduate)
    ...
    > <img src = "IMPORT FILES/BrownCertificateIco.png" alt = "Brown Certificate Icon" height = "20"> : by the Civil Service Commission (CSC) of the Philippines<br>
...
- #### TEST OF ENGLISH FOR INTERNATIONAL COMMUNICATION (TOEIC) CERTIFICATION <br> Common European Framework of Reference for Languages (CEFR)
    ...
    > <img src = "IMPORT FILES/BrownCertificateIco.png" alt = "Brown Certificate Icon" height = "20"> : by the Hopkins International Partners Inc.<br>
