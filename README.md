<div style = "display: flex; flex-direction: column; align-items: center;">
    ...
    <div style="display: flex; justify-content: space-between; width: 100%;">
        ...
        <!-- E-MAIL -->
        <a href = norieneil_acosta@outlook.com title = "E-MAIL: norieneil_acosta@outlook.com"> <img src = "IMPORT FILES/EmailIcon.png" alt = "Email Address" height = "32.2" style = "width: 4%;"></a>
        <!-- PHONE -->
